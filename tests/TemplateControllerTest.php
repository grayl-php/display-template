 ...
 */
class TemplateControllerTest extends
    TestCase
{
     ...
     */
    public function testTemplateControllerDataFromRender(
        ...
        $this->assertEquals(
            'testing ' . $template->getVariable('int'),
            $output
        );
    }
     ...
     */
    public function testTemplateControllerDataFromRaw(
        TemplateController $template
    ): void {
     ...
     */
    public function testSavedTemplateControllerData(TemplateController $template
    ): void {
     ...
     * @depends testCreateSavedTemplateController
     */
    public function testSavedTemplateControllerDataFromRender(
        TemplateController $template
    ): void {
