...
class TemplatePorter
{
     ...
     */
    public function newTemplateControllerFromFile(string $filename
    ): TemplateController {
     ...
     * @return TemplateController
     */
    public function getSavedTemplateController(string $filename
    ): TemplateController {
        ...
        if (empty ($controller)) {
            ...
            // Save it for re-use
            $this->saved_templates->setVariable(
                $template_id,
                $controller
            );
        }
