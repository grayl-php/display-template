<?php
   ...
   class TemplateController
   {
       ...
       */
      public function __construct ( TemplateData $template_data,
      ...
      public function getRenderedTemplate (): string
      {
         ...
         // Render the template
         return $this->template_service->getRenderedTemplate( $this->template_data,
                                                              $this->template_file );
      }
                                    ...
                                    $value ): void
      {
         ...
         // Set the variable
         $this->template_data->setVariable( $key,
                                            $value );
      }
